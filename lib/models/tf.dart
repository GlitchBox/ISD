...
class TF{
  ...
  TF._({int id,String question,String answer,String explanation,int topicId}):
  _id=id,
  _question=question,
  _answer=answer,
  ...
  */
  ...
  TF.fromMapObject(Map<String, dynamic> map) {
    this._id = map['Id'];
