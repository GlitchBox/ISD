...
class SME extends MixTask{
  ...
  //String _explanation;
   ...
   SME.mixTask({int id,String first_segment,String last_segment,String broken_sentence,String englishSentence,String banglaSentence}):
