...
class TrueFalseState extends State<TrueFalseTask> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, MainModel model) {
          if (!widget.call_flag) {
            model.generateTrueFalse();
            widget.call_flag = true;
          }
          return Container(
            child: model.isTFLoading
                ? Center(
                ...
                : Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: progressDetails(model.truefalselist.length),
                      ),
                      Positioned(
                        top: 150,
                        left: 20,
                        ...
                        child: SizedBox(
                          ...
                          child: PageView.builder(
                            ...
                            itemCount: model.truefalselist.length >= 10
                                ? 10
                                : model.truefalselist.length,
                            itemBuilder: (BuildContext context, int index) {
                              return TrueFalseCard(
                                question: model.truefalselist[index].question,
                                answer: model.truefalselist[index].answer,
                                index: (index + 1).toString(),
                                explaination:
                                    model.truefalselist[index].explanation,
                              );
                            },
                          ),
                        ),
