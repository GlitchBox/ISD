...
class ListeningTask extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ListeningTaskState();
  }
}

class ListeningTaskState extends State<ListeningTask> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, MainModel model) {
          if (!widget.call_flag) {
            model.generateListeningItems();
            widget.call_flag = true;
          }
          return Container(
            child: model.isLTLoading
                ? Center(
                ...
                : Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: progressDetails(model.ltitemlist.length),
                      ),
                      Positioned(
                        top: 150,
                        left: 20,
                        ...
                        child: SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: model.ltitemlist.length >= 10
                                  ? 10
                                  : model.ltitemlist.length,
                              itemBuilder: (BuildContext context, int index) {
                                return ListeningCard(model.ltitemlist[index]);
                              },
                            )),
                      ),
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: FlatButton(
                            onPressed: () {
                              setState(() {
                                if (widget.current < model.ltitemlist.length) {
                                  widget.current++;
                                } else {
