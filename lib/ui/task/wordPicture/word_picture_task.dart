...
class WordPictureTask extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return WordPictureState();
  }
}

class WordPictureState extends State<WordPictureTask> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, MainModel model) {
          if (!widget.call_flag) {
            model.generateWordtoPicture();
            widget.call_flag = true;
          }
          return Container(
            child: model.isWPLoading
                ? Center(
                ...
                : Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: progressDetails(model.wordpicturelist.length),
                      ),
                      Positioned(
                        top: 150,
                        left: 20,
                        ...
                        child: SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: model.wordpicturelist.length >= 10
                                  ? 10
                                  : model.wordpicturelist.length,
                              itemBuilder: (BuildContext context, int index) {
                                return WordPictureCard(
                                    model.wordpicturelist[index]);
                              },
                            )),
                      ),
                      Positioned(
