...
import 'package:Dimik/data/rest/fb.dart';
...
class LoginScreenPresenter {
  ...
  doLogin(String username, String password) async{
    ...
    */
    User user = await uController.login(username, password);
    print(user.token);
  ...
  doRegister(String email, String username, String password) {
    api.register(email, username, password).then((Token token) {
      _view.onLoginSuccess(token.toString());
