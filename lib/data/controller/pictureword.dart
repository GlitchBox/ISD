...
class PWController{
  ...
  Future<List<PictureWord> >getPWList(String token,int topicId)async{
    ...
    {
        PictureWordList pwList=await pwRest.getAllQuestions(token,topicId).catchError((Object onError){
        ...
        print('One Piece');
        return pwList.pwList;
    }
    List<PictureWord> result = await pwDatabaseHelper.getPWList(topicId);
    return result;
  }
