...
class MainDatabaseHelper {
  ...
  void _onCreate(Database db, int version) async {
    ...
    await db.execute(
        ...
        "$topicImageLinkCol TEXT,$topicIsLovedCol INTEGER,$topicProgressCol TEXT)");
    ...
    await db.execute(
        ...
        "$tfQuestionCol TEXT,$tfAnswerCol TEXT,$tfExplanationCol TEXT,$tfTopicIdCol INTEGER, FOREIGN KEY($tfTopicIdCol) REFERENCES $topicTable($topicIdCol))");
