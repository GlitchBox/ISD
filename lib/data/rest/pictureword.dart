...
import '../../models/pictureword.dart';
import 'dart:async';
...
class PWRest {
  ...
  Future<PictureWordList> getAllQuestions(String token,int topicId) {
    ...
    return _netUtil.get(PW_URL,headers: headers).then((dynamic res) {
      print("DEBUG :=====================\n"+
      res.toString()+"\n=====================\n");
      ...
      pwList = new PictureWordList.fromJson(res);
      pwList.setTopicId(topicId);
