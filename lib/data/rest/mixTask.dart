...
class MixTaskRest{
 ...
 // static String M_URL= "https://5cf132f13db50700145db61f.mockapi.io/api/auth/";
  ...
  Future <MixTaskList> getAllTask(String token,String topicID)
  { 
    ...
    */
    headers["topic_id"]="1";
    //print(topicID);
    return _netUtil.get(MIXTASK_URL,headers:headers).then((dynamic res){
      print("DEBUG :=====================\n"+
      res.toString()+"\n=====================\n");
      ...
      smList= new MixTaskList.fromJson(res);
